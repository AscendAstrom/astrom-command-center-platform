      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Analytics engine operational</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Data streaming active</p>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            <p className="text-muted-foreground">
              Advanced analytics features will be available once data is populated.
            </p>
          </div>
        </CardContent>
      </Card>
